...
filepath = "C:\\Users\\tians\\kx01\\dicom-pre"
dcm = pydicom.dcmread(os.path.join(filepath, "CAO^PING2.dcm"))


os.chmod(filepath, stat.S_IRUSR | stat.S_IWUSR | stat.S_IXUSR)
for f in os.listdir(filepath):
    os.chmod(os.path.join(filepath, f), stat.S_IRUSR | stat.S_IWUSR | stat.S_IXUSR)
